...
def abrirv():
    ...
    def clientes():
        ...
        inf.pack()
        inf.config(bg="white", fg="blue", font=("georgia", 30))
        inf.place(x="30", y="20")

        tabla1=ttk.Treeview(cli, columns=("Nombre", "ApellidoP", "ApellidoM", "Edad"))
        tabla1.insert("",END,text="JR1",values=("Juan", "Ramirez", "Perez", "40"))
        tabla1.insert("",END,text="IL2",values=("Ignacio", "Lopez", "Rodriguez", "34"))
        tabla1.insert("",END,text="EE3",values=("Eduardo", "Escamilla", "Leon", "28"))
        tabla1.insert("",END,text="MD4",values=("Mario", "Dorantes", "Lopez", "50"))
        tabla1.heading("#0", text="ID")
        tabla1.heading("Nombre", text="Nombre")
        tabla1.heading("ApellidoP", text="Apellido P")
        tabla1.heading("ApellidoM", text="Apellido M")
    ...
    def articulos():
        ...
        tabla2.insert("",END,text="ABCD",values=("Lapiz", "Negro", "20", "$10"))
        tabla2.insert("",END,text="DEFG",values=("Libreta", "Rojo", "10", "$30"))
        tabla2.insert("",END,text="HIJK",values=("Hojas", "colores", "7", "$2"))
        tabla2.insert("",END,text="LMNO",values=("Goma", "Blanca", "8", "$8"))
        tabla2.insert("",END,text="PQRS",values=("Tijeras", "Colores", "4", "$40"))
        tabla2.insert("",END,text="TUVW",values=("Resistol", "Verde", "28", "$10"))
        tabla2.insert("",END,text="XYZA",values=("Cartulina", "Colres", "16", "$18"))
        tabla2.insert("",END,text="BCDE",values=("USB", "Azul", "30", "$160"))
        tabla2.insert("",END,text="FGHI",values=("Micro SD", "Negro", "40", "$180"))
        tabla2.insert("",END,text="JKLM",values=("Mapas", "Colores", "13", "$6"))
